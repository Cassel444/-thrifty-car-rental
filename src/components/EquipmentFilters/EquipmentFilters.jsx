...
import { equipmentOptions, iconMapping } from "../../constants/constants";
    ...
    <div className={css.options}>
      {equipmentOptions.map(({ main, defaultText, options }) => (
        <div key={main} className={css.box}>
          <div onClick={() => options && handleToggle(main)} className={css.labelWrapper}>
            <svg height={32} width={32}>
              <use href={`/sprite.svg#icon-${iconMapping[defaultText] || iconMapping[main]}`} />
            </svg>
